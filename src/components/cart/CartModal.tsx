  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div
          ref={modalRef}
          className="bg-white dark:bg-gray-900 shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            ...
            <button
              ref={closeButtonRef}
              onClick={onClose}
              className="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-400 transition-colors"
          ...
          <div className="overflow-y-auto max-h-[calc(90vh-200px)] p-6">
            {cartItems.length === 0 ? (
              <div className="text-center py-12">
                ...
                <button
                  onClick={onClose}
                  className="mt-4 px-6 py-2 bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-400 transition-colors"
                >
                  Continue Shopping
                </button>
              </div>
